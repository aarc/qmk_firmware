...
// ME
#define G_MUTE     LCTL(KC_D) // Ctrl + d
#define G_CAM     LCTL(KC_E) // Ctrl + e
#define G_CHAT     LCA(KC_C) //Ctrl + Alt + c


const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  [0] = LAYOUT_ortho_3x10(
    G_MUTE,       G_MUTE,       G_MUTE,       G_MUTE,       G_MUTE,       G_CHAT,       G_CHAT,       G_CHAT,       G_CHAT,       G_CHAT,
    G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,        G_CAM,
    LT(1,G_CHAT), LT(2,G_CHAT), LT(3,G_CHAT), LT(4,G_CHAT), LT(5,G_CHAT), LT(6,G_MUTE), LT(7,G_MUTE), LT(8,G_MUTE), LT(9,G_MUTE), LT(10,G_MUTE)
  ),
